import{$ as e,e as d,C as l,A as u}from"./main-Cr4k92Ug.js";function r(s){let t=e("input[data-team-id]:checked").map(function(){return e(this).data("team-id")}),i=t.length===1?"team":"teams";d({title:"Delete Teams",body:`Are you sure you want to delete ${t.length} ${i}?`,success:function(){const a=[];for(var o of t)a.push(l.fetch(`/api/v1/teams/${o}`,{method:"DELETE"}));Promise.all(a).then(n=>{window.location.reload()})}})}function c(s){let t=e("input[data-team-id]:checked").map(function(){return e(this).data("team-id")});u({title:"Edit Teams",body:e(`
