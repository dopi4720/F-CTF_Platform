import{$ as e,e as a,C as l,A as u}from"./main-Cr4k92Ug.js";function d(r){let t=e("input[data-user-id]:checked").map(function(){return e(this).data("user-id")}),s=t.length===1?"user":"users";a({title:"Delete Users",body:`Are you sure you want to delete ${t.length} ${s}?`,success:function(){const i=[];for(var o of t)i.push(l.fetch(`/api/v1/users/${o}`,{method:"DELETE"}));Promise.all(i).then(n=>{window.location.reload()})}})}function c(r){let t=e("input[data-user-id]:checked").map(function(){return e(this).data("user-id")});u({title:"Edit Users",body:e(` 
